/* 
 Most of the code in this tab has been generated from the GUI form
 designer and care should be taken when editing this file.
 It is recommended that you only add/edit code inside the event handlers i.e. only use lines between the matching comment tags. e.g.
...
public void createGUI(){
  ...
  duringGameWindow = GWindow.getWindow(this, "Control Window", -1000, -1000, 420, 200, JAVA2D);
  ...
  preGameWindow = GWindow.getWindow(this, "Customize Window", -1000, -1000, 560, 200, JAVA2D);
